...
////        ContentCachingRequestWrapper cachingRequest = (ContentCachingRequestWrapper) httpServletRequestWrapper;
//        System.out.println(cachingRequest.getClass());
...
//        log.info(HTTP_LOG_FORMAT,method , uri ,queryString , header ,cachingRequest.getContentAsByteArray(),handler,response.getStatus(),objectMapper.readTree(cachingResponse.getContentAsByteArray()));
//    }
}
