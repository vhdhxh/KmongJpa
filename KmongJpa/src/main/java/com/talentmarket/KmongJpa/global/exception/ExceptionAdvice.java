...
public class ExceptionAdvice {
    ...
    public  ApiResponse ObjectOptimisticLockingFailureException(ObjectOptimisticLockingFailureException exception) {

        return ApiResponse.of(HttpStatus.BAD_REQUEST,"재고가 부족합니다",null);
    }
